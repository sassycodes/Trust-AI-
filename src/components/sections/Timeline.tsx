...
const Timeline = () => {
    const events = [
        { date: "Jan 20", title: "Registrations Open", desc: "Start of the journey." },
        { date: "Feb 05", title: "Proposal Submission", desc: "Submit your team's abstract." },
        { date: "Feb 07", title: "Finalists Announced", desc: "Top 20 teams selected." },
